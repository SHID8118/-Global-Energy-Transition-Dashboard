...
- Use the column **`gdp per capita`** (already provided) to classify:
    * **Developed** ▶︎ GDP‑per‑capita ≥ 25 000 USD (2015 constant)
    * **Developing** ▶︎ below that threshold.
...
# merge on ISO code
merged = owid_df.merge(wb_df[["iso_code", "dev_status"]], on="iso_code", how="left")
